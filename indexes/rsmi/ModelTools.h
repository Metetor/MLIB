...
namespace rsmiutils
{
    ...
    public:
        ...
        torch::Tensor forward(torch::Tensor x)
        {
            ...
            //std::cout << "debug relu:" << std::endl;
            //std::cout << x.sizes() << std::endl;
            x = fc1->forward(x);
            //std::cout << x.sizes() << std::endl;
            // std::cout << "fc1->forward" << std::endl;

            // std::cout << "Input tensor dtype: " << x.dtype() << std::endl;
            // std::cout << "Input tensor min value: " << x.min().item().toFloat() << std::endl;
            // std::cout << "Input tensor max value: " << x.max().item().toFloat() << std::endl;
            ...
            {
                std::cout << "An error occurred: " << e.msg() << std::endl;
            }
            //std::cout << "relu end:" << std::endl;
            // x = fc1->forward(x);
            x = fc2->forward(x);
        ...
        {
            //std::cout << "enter train_model" << std::endl;
            ...
            if (N > 64000000)
            {
                //std::cout << "enter branch N>6.4e7" << std::endl;
                int batch_num = 4;
            ...
            {
                //std::cout << "enter branch 2 N<" << std::endl;
                for (size_t epoch = 0; epoch < Constants::EPOCH; epoch++)
                {
                    ...
                    try
                    {
                       // std::cout << "begin forward" << std::endl;
                        torch::Tensor output = this->forward(x);
                        //std::cout << "after forward" << std::endl;
                        loss = torch::mse_loss(output, y);
                        // 这里可以继续处理 loss
                    }
                    catch (const c10::Error &e)
                    {
